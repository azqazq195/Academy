...
import com.example.apptest.helper.FileUtils;
import com.example.apptest.helper.PhotoHelper;
...
public class InputActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    String url = "http://192.168.55.172:8081/apptest/member/member_insert.do";
    // 업로드할 사진파일의 경로
        ...
        switch (v.getId()) {
            ...
            case R.id.button2:  // 저장하기
                ...
                if(msg==null && name.equals("")) {
                    msg = "이름을 입력하세요";
                } else if(msg==null && phone.equals("")) {
                    msg = "핸드폰 번호를 입력하세요";
                } else if(msg==null && email.equals("")) {
                    msg = "이메일을 입력하세요";
                } else if(msg==null && addr.equals("")) {
                    msg = "주소를 입력하세요";
    ...
    class HttpResponse extends AsyncHttpResponseHandler {
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            ...
            try {
                ...
                if(rt.equals("OK")) {
                    Toast.makeText(InputActivity.this, "저장 성공", Toast.LENGTH_SHORT).show();
                    finish(); // 현재 액티비티 종료 -> 메인으로 돌아가기
                } else {
                    Toast.makeText(InputActivity.this, "저장 실패", Toast.LENGTH_SHORT).show();
                }
        ...
        public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
            Toast.makeText(InputActivity.this, "통신 실패", Toast.LENGTH_SHORT).show();
        }
    }
}