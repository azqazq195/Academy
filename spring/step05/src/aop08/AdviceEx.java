...
public class AdviceEx {
	...
	public void around(ProceedingJoinPoint jp) throws Throwable {
		System.out.println("JointPoint 양쪽의 전에 실행되는 Advice");
		jp.proceed();
		System.out.println("JointPoint 양쪽의 후에 실행되는 Advice");
	}
	
	@Before("execution(* zeroMethod(..))")
	public void before() {
		System.out.println("JointPoint 앞에서 실행되는 Advice");
	}
	
	@After("execution(* zeroMethod(..))")
	public void after() {
		System.out.println("JointPoint 뒤에서 실행되는 Advice");
	}
	...
	public void afterReturning(Object ret) {
		System.out.println("JointPoint가 정상 종료후 실행되는 Advice");
	}
}
