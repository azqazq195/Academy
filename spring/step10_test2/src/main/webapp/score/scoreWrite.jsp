...
<%	// 데이터
	...
	int kor = Integer.parseInt(request.getParameter("studNo"));
	int eng = Integer.parseInt(request.getParameter("studNo"));
	int mat = Integer.parseInt(request.getParameter("studNo"));
	int tot = kor + eng + mat;
